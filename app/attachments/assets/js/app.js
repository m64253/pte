	...
	var indexOf = function (arr, value) {
		...
		component = {
			...
			register: function (name, deps, builder) {
				...
				this.REGISTRY[name] = new Builder(name, deps, builder, this);
...
APP.register('team.model', function () {
